...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-rbvv-rs.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-rbvv-rs.containers.anotherwebservice.com/
...
```
git clone git@github.com:jayaranah/container-rbvv-rs.git
cd container-rbvv-rs
```
...
```
docker attach container-rbvv-rs
```
